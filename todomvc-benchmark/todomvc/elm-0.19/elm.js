...
var $author$project$Main$emptyModel = {a: _List_Nil, o: '', z: 0, A: 'All'};
...
var $author$project$Main$newEntry = F2(
	function (desc, id) {
		return {h: false, v: desc, C: false, f: id};
	});
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: $elm$core$String$isEmpty(model.o) ? model.a : _Utils_ap(
								model.a,
								_List_fromArray(
									[
										A2($author$project$Main$newEntry, model.o, model.z)
									])),
							o: '',
							z: model.z + 1
						}),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(todo.v),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewInput, model.o),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewEntries, model.A, model.a),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewControls, model.A, model.a)
					])),
										...
										return A2(
											...
											function (entries) {
												return $elm$json$Json$Decode$succeed(
													{a: entries, o: field, z: uid, A: visibility});
											},
											A2(
																	...
																	return A2(
																		...
																		function (description) {
																			return A2(
																				...
																				function (completed) {
																					return $elm$json$Json$Decode$succeed(
																						{h: completed, v: description, C: editing, f: id});
																				},
