...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "mn-editor.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            return fetch( "mn-editor.wasm", {credentials: "same-origin"} )
                .then( function( response ) { return response.arrayBuffer(); } )
                .then( function( bytes ) { return WebAssembly.compile( bytes ); } )
                .then( function( mod ) { return WebAssembly.instantiate( mod, instance.imports ) } )
                .then( function( wasm_instance ) {
                    var exports = instance.initialize( wasm_instance );
                    console.log( "Finished loading Rust wasm module 'mn_editor'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'mn_editor':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_5b102e1eeb8383e8343b7eceacae503fe6f8f289": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){var isInViewport = function (elem){var bounding = elem.getBoundingClientRect (); return (bounding.top >= 0 && bounding.left >= 0 && bounding.bottom <= (window.innerHeight || document.documentElement.clientHeight)&& bounding.right <= (window.innerWidth || document.documentElement.clientWidth));}; var focused = document.querySelector (".focused"); if (focused && ! isInViewport (focused)){focused.scrollIntoView ({behavior : "smooth" , block : "center" , inline : "center"});}})());
            },
            ...
            "__extjs_345d2751492b7e5bf0fc5057a7c327e41c7c043d": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){var elm = document.querySelector ("#input"); if (elm){elm.focus ();}})());
            },
