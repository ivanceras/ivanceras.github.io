...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'svgbob_editor-d673cef1837fe052.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'svgbob_editor-d673cef1837fe052.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'svgbob_editor-d673cef1837fe052.asm.js';
...
var ASM_CONSTS = [function($0) { Module.STDWEB.tmp = Module.STDWEB.to_js( $0 ); },
 ...
 function($0) { Module.STDWEB.from_js($0, (function(){var loading = document.querySelector ("#loading"); document.body.removeChild (loading); var content = document.querySelector ("#content"); content.style.visibility = "visible" ;})()); },
 function($0, $1) { Module.STDWEB.from_js($0, (function(){var get_window_dimension = Module.STDWEB.to_js($1); window.addEventListener ("resize" , throttle (function (e){get_window_dimension ();}, 100)); get_window_dimension.drop ();})()); },
 ...
 function($0, $1) { Module.STDWEB.from_js($0, (function(){var set_active_tool_xray = Module.STDWEB.to_js($1); svgeditor.addEventListener ("mouseover" , function (e){set_active_tool_xray ();}); set_active_tool_xray.drop ();})()); },
 function($0, $1, $2) { Module.STDWEB.from_js($0, (function(){var process_keys = Module.STDWEB.to_js($1); var is_svgeditor_focused = Module.STDWEB.to_js($2); window.addEventListener ("keydown" , function (e){if (e.altKey || e.ctrlKey || e.metaKey || ! is_svgeditor_focused ()){return ;}else {e.preventDefault (); var code = e.code ; var key = e.key ; throttle (function (){process_keys (code , key)}, 400)();}}); process_keys.drop (); is_svgeditor_focused.drop ();})()); },
 ...
 function($0, $1) { Module.STDWEB.from_js($0, (function(){var set_window_dimension = Module.STDWEB.to_js($1); var height = window.innerHeight ; var width = window.innerWidth ; set_window_dimension (width , height); set_window_dimension.drop ();})()); },
 ...
 function($0) { Module.STDWEB.from_js($0, (function(){var tool = document.querySelector ("#tool"); tool.style.display = "none" ;})()); },
 function($0) { Module.STDWEB.from_js($0, (function(){var tool = document.querySelector ("#tool"); tool.style.display = "block" ;})()); },
...
STATICTOP = STATIC_BASE + 62448;
  /* global initializers */  __ATINIT__.push();
  

memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "svgbob_editor-d673cef1837fe052.js.mem" : null;




var STATIC_BUMP = 62448;
...
// {{PRE_LIBRARY}}
  ...
  var _llvm_round_f32=Math_round;
...
Module['wasmTableSize'] = 48128;

Module['wasmMaxTableSize'] = 48128;
...
//# sourceMappingURL=svgbob_editor-d673cef1837fe052.js.map